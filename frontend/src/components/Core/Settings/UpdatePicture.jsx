...
const UpdatePicture = () => {
  ...
  return (
    <>
       <div className="flex items-center justify-between rounded-md border-[1px] border-yellow-400  bg-soft-gray p-8 px-12 text-richblack-5">
        <div className="flex items-center gap-x-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-row gap-3">
              ...
              <button
                onClick={handleClick}
                className="cursor-pointer rounded-md bg-white py-2 px-5 font-semibold blackButton"
              >
                Select
              </button>
              <IconBtn
